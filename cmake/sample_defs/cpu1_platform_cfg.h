...
*/
const uint16 CFE_PLATFORM_SB_FILTERED_EVENT1 = CFE_SB_SEND_NO_SUBS_EID;
const uint16 CFE_PLATFORM_SB_FILTER_MASK1    = CFE_EVS_FIRST_4_STOP;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT2 = CFE_SB_DUP_SUBSCRIP_EID;
const uint16 CFE_PLATFORM_SB_FILTER_MASK2    = CFE_EVS_FIRST_4_STOP;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT3 = CFE_SB_MSGID_LIM_ERR_EID;
const uint16 CFE_PLATFORM_SB_FILTER_MASK3    = CFE_EVS_FIRST_16_STOP;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT4 = CFE_SB_Q_FULL_ERR_EID;
const uint16 CFE_PLATFORM_SB_FILTER_MASK4    = CFE_EVS_FIRST_16_STOP;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT5 = 0;
const uint16 CFE_PLATFORM_SB_FILTER_MASK5    = CFE_EVS_NO_FILTER;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT6 = 0;
const uint16 CFE_PLATFORM_SB_FILTER_MASK6    = CFE_EVS_NO_FILTER;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT7 = 0;
const uint16 CFE_PLATFORM_SB_FILTER_MASK7    = CFE_EVS_NO_FILTER;

const uint16 CFE_PLATFORM_SB_FILTERED_EVENT8 = 0;
const uint16 CFE_PLATFORM_SB_FILTER_MASK8    = CFE_EVS_NO_FILTER;
